...
namespace Naloga4 {
    ...
    public partial class northwndDataSet : global::System.Data.DataSet {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public OrdersRow AddOrdersRow(CustomersRow parentCustomersRowByFK_Orders_Customers, System.DateTime OrderDate, string ShipAddress, string ShipCity, string ShipCountry) {
...
namespace Naloga4.northwndDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Naloga4.Properties.Settings.Default.northwndConnectionString;
        }
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Orders] WHERE (([OrderID] = @Original_OrderID) AND ((@IsNull_CustomerID = 1 AND [CustomerID] IS NULL) OR ([CustomerID] = @Original_CustomerID)) AND ((@IsNull_OrderDate = 1 AND [OrderDate] IS NULL) OR ([OrderDate] = @Original_OrderDate)) AND ((@IsNull_ShipAddress = 1 AND [ShipAddress] IS NULL) OR ([ShipAddress] = @Original_ShipAddress)) AND ((@IsNull_ShipCity = 1 AND [ShipCity] IS NULL) OR ([ShipCity] = @Original_ShipCity)) AND ((@IsNull_ShipCountry = 1 AND [ShipCountry] IS NULL) OR ([ShipCountry] = @Original_ShipCountry)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Orders] ([CustomerID], [OrderDate], [ShipAddress], [ShipCity], [ShipCountry]) VALUES (@CustomerID, @OrderDate, @ShipAddress, @ShipCity, @ShipCountry);
SELECT OrderID, CustomerID, OrderDate, ShipAddress, ShipCity, ShipCountry FROM Orders WHERE (OrderID = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CustomerID", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Orders] SET [CustomerID] = @CustomerID, [OrderDate] = @OrderDate, [ShipAddress] = @ShipAddress, [ShipCity] = @ShipCity, [ShipCountry] = @ShipCountry WHERE (([OrderID] = @Original_OrderID) AND ((@IsNull_CustomerID = 1 AND [CustomerID] IS NULL) OR ([CustomerID] = @Original_CustomerID)) AND ((@IsNull_OrderDate = 1 AND [OrderDate] IS NULL) OR ([OrderDate] = @Original_OrderDate)) AND ((@IsNull_ShipAddress = 1 AND [ShipAddress] IS NULL) OR ([ShipAddress] = @Original_ShipAddress)) AND ((@IsNull_ShipCity = 1 AND [ShipCity] IS NULL) OR ([ShipCity] = @Original_ShipCity)) AND ((@IsNull_ShipCountry = 1 AND [ShipCountry] IS NULL) OR ([ShipCountry] = @Original_ShipCountry)));
SELECT OrderID, CustomerID, OrderDate, ShipAddress, ShipCity, ShipCountry FROM Orders WHERE (OrderID = @OrderID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CustomerID", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT OrderID, CustomerID, OrderDate, ShipAddress, ShipCity, ShipCountry FROM db" +
                "o.Orders";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_OrderID, string Original_CustomerID, global::System.Nullable<global::System.DateTime> Original_OrderDate, string Original_ShipAddress, string Original_ShipCity, string Original_ShipCountry) {
            ...
            if ((Original_ShipCity == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((string)(Original_ShipCity));
            }
            if ((Original_ShipCountry == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((string)(Original_ShipCountry));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string CustomerID, global::System.Nullable<global::System.DateTime> OrderDate, string ShipAddress, string ShipCity, string ShipCountry) {
            if ((CustomerID == null)) {
            ...
            if ((ShipCountry == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(ShipCountry));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.InsertCommand.Connection.State;
            if (((this.Adapter.InsertCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CustomerID, global::System.Nullable<global::System.DateTime> OrderDate, string ShipAddress, string ShipCity, string ShipCountry, int Original_OrderID, string Original_CustomerID, global::System.Nullable<global::System.DateTime> Original_OrderDate, string Original_ShipAddress, string Original_ShipCity, string Original_ShipCountry, int OrderID) {
            if ((CustomerID == null)) {
            ...
            if ((ShipCountry == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(ShipCountry));
            }
            ...
            if ((Original_ShipAddress == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_ShipAddress));
            }
            if ((Original_ShipCity == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_ShipCity));
            }
            if ((Original_ShipCountry == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_ShipCountry));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CustomerID, global::System.Nullable<global::System.DateTime> OrderDate, string ShipAddress, string ShipCity, string ShipCountry, int Original_OrderID, string Original_CustomerID, global::System.Nullable<global::System.DateTime> Original_OrderDate, string Original_ShipAddress, string Original_ShipCity, string Original_ShipCountry) {
            return this.Update(CustomerID, OrderDate, ShipAddress, ShipCity, ShipCountry, Original_OrderID, Original_CustomerID, Original_OrderDate, Original_ShipAddress, Original_ShipCity, Original_ShipCountry, Original_OrderID);
        }
    }
